 ...
 * Usage:
 *   node scripts/bench/bench.js --size 10000 --preset examples/presets/low-latency.json [--http] [--doh]
 */
...
function parseArgs() {
  ...
  const out = { size: 100, preset: '', http: false, doh: false };
...
function main() {
  const { size, preset, http, doh } = parseArgs();
